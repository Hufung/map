...
export const createPermitIcon = () => L.divIcon({
    className: 'flex items-center justify-center bg-orange-500 text-white font-bold rounded-full border-2 border-white shadow-lg',
    html: '<span>P</span>',
    iconSize: [24, 24],
    iconAnchor: [12, 12]
});
